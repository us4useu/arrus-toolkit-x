            ...
            if(acq_type == 'ssi'):
                ...
                for i in range(3):
                    ...
                    for j in range(10):
                        ...
                        Bmode = cpu_data[0]
                        sws   = cpu_data[1]
                        scipy.io.savemat(path + 'sws' +'_id_' + str(j) + '_shift_' + str(pb_shift[i]) + '_B.mat', dict(data=sws))
                        scipy.io.savemat(path + 'bmode' +'_id_' + str(j) + '_shift_' + str(pb_shift[i]) + '_B.mat', dict(data=Bmode))
