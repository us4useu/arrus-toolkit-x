...
def main(pwiFreq, pwiCycles, pwiPri, idx):
    ...
    ############## PARAMETERS #############################################
    path          = './Parametric_tests/Test_1/i/'
    acq_type      = 'cpwi'           # Acquisition type: {'ssi', 'cuse', 'cpwi'}

    ## ACQUISITION PARAMETERS #####
    # Push parameters
    pb_tx_freq    = [4.4] #[4.4, 4.4, 4.4]  # Push beam frequency [MHz]
    pb_tx_length  = [200] #[150, 150, 150]  # Push beam duration [us]
    ...
    with arrus.Session("./us4r.prototxt") as sess:
        ...
        if(txpb_issue == 0):
            ...
            # Save data
            #scipy.io.savemat(path + 'sws' + '_freq' + str(pb_freq) + '_foc' + str(pb_focus) + '_rep' + str(rep) + '.mat', dict(data=sws))
