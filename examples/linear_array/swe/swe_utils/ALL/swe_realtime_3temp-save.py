...
pb_aperture   = [62]  #[32, 42, 51]     # Push beam aperture [# of elements of each beam] - must be even
...
rf_filter_numtaps     = 128           # Size of the FIR filter (# of taps)
...
swse_d             = 20                     # SWS estimation kernel size (in pixels)
...
#swse_x_range       = [[50, 300], [0, 150]]  # Range within x-dimension to perform SWS estimation (LR and RL, repsectively) 0.2
swse_x_range       = [[60, 300], [0, 150]]  # Range within x-dimension to perform SWS estimation (LR and RL, repsectively) 0.2
#swse_x_range       = [[60, 240], [0, 100]]  # Range within x-dimension to perform SWS estimation (LR and RL, repsectively) 0.25
...
with arrus.Session("./us4r.prototxt") as sess:
    ...
    if(txpb_issue == 0):
        ...
        for i in range(120):
            ...
            # Dump some data  
            scipy.io.savemat(path + 'sws_homo_test.mat', dict(data=sws))  
            scipy.io.savemat(path + 'sws_homo_precmpd_test.mat', dict(data=sws_precmpd))  
