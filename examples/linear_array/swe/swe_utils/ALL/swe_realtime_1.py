...
# Post-processing
median_filter_size = 11    # Median filter kernel size. Kernel is a square.
...
with arrus.Session("./us4r.prototxt") as sess:
    ...
    if(txpb_issue == 0):
        ...
        for i in range(15):
            ...
            for j in range(50): # FPS defined here!
            ...
            #time.sleep(0.5)  # FPS defined here!
            print("Mempool used bytes [MB]: {:f}".format(mempool.used_bytes()/1024/1024))
            print("Mempool total bytes [MB]: {:f}".format(mempool.total_bytes()/1024/1024))
